...
export const REVOS: RevosDef[] = [
  {
    id: 'gravodon', name: 'グラヴォドン', en: 'Gravodon', element: 'terra', role: 'Tank',
    hp: 1650, atk: 88, def: 148, spd: 72, basicPower: 85,
    ...
    flavor: '足跡が地層に残るほど重い。倒れるときの震動が仲間を奮い立たせる。',
  },
  {
    id: 'ignirapt', name: 'イグニラプト', en: 'Ignirapt', element: 'flame', role: 'Striker',
    ...
    flavor: '爪の付け根に熱を溜める器官がある。走った跡の砂がガラス化する。',
  },
  {
    id: 'abyssmaul', name: 'アビスモール', en: 'Abyssmaul', element: 'aqua', role: 'Breaker',
    ...
    flavor: '遅いのではなく、急ぐ必要がなかった。深海に追う者はいない。',
  },
  {
    id: 'cerciwing', name: 'セルシウィング', en: 'Cerciwing', element: 'gale', role: 'Sprinter',
    hp: 1000, atk: 120, def: 74, spd: 146, basicPower: 84,
    passive: { id: 'vanguard', name: '先陣', desc: '戦闘開始時 AV +3500。ロスター最速。' },
    od: { id: 'galerend', name: '疾風裂波', desc: '敵全体を切り裂き、自分は即座に再行動する。', power: 75 },
    build: { archetype: 'pterosaur', seed: 4044, bulk: 0.85, scale: 1.0, crest: true },
    habitat: ['frostpeak', 'canyon'], rarity: 3,
    flavor: '風を待たない。翼で風を作る側の生き物。',
  },
  {
    id: 'terracrest', name: 'テラクレスト', en: 'Terracrest', element: 'terra', role: 'Guardian',
    hp: 1300, atk: 100, def: 126, spd: 84, basicPower: 86,
    passive: { id: 'sediment', name: '堆積', desc: '行動するたび自身の DEF +8%（最大 +40%、戦闘中持続）。' },
    od: { id: 'rockaegis', name: '岩盾展開', desc: '味方全体に DEF 基準の吸収シールド（4行動）。', power: 0 },
    build: { archetype: 'ceratopsian', seed: 5055, bulk: 1.05, scale: 1.05, horns: 5 },
    habitat: ['canyon', 'frostpeak'], rarity: 2,
    flavor: 'フリルは威嚇ではなく、風化した地層そのものを盾にしている。',
  },
  {
    id: 'pyroceras', name: 'ピュロケラス', en: 'Pyroceras', element: 'flame', role: 'Tank',
    hp: 1440, atk: 104, def: 130, spd: 70, basicPower: 86,
    passive: { id: 'heatreflect', name: '熱反射', desc: '被物理ダメージの 18% を攻撃者に返す。' },
    ...
    flavor: '背板に血流を通して放熱する。怒ると板が赤熱する。',
  },
  {
    id: 'nereidon', name: 'ネレイドン', en: 'Nereidon', element: 'aqua', role: 'Healer',
    ...
    habitat: ['tidehollow'], rarity: 3,
    flavor: '群れの誰かが沈むと、残りが浮かび上がる。理由はまだ分かっていない。',
  },
  {
    id: 'zepharis', name: 'ゼファリス', en: 'Zepharis', element: 'gale', role: 'Debuffer',
    ...
    flavor: '羽毛の1枚ごとに向きが違う。通り過ぎた岩に細かい傷が残る。',
  },
  {
    id: 'obsidon', name: 'オブシドン', en: 'Obsidon', element: 'null', role: 'All-round',
    ...
    flavor: '骨が黒曜石に置換されている。どの属性の力も通り抜けていく。',
  },
  {
    id: 'luminax', name: 'ルミナクス', en: 'Luminax', element: 'null', role: 'Buffer',
    ...
    habitat: ['frostpeak', 'canyon'], rarity: 3,
    flavor: 'フリルが共鳴して低い音を出す。群れ全体の呼吸が揃っていく。',
  },
  {
    id: 'tectos', name: 'テクトス', en: 'Tectos', element: 'terra', role: 'Technical',
    hp: 1380, atk: 132, def: 110, spd: 88, basicPower: 90,
    passive: { id: 'traction', name: '牽引', desc: '後列の敵への与ダメージ +26%。' },
    ...
    flavor: '獲物を隊列ごと引きずる。逃げ場を消してから噛む。',
  },
  {
    id: 'volcanix', name: 'ヴォルカニクス', en: 'Volcanix', element: 'flame', role: 'Finisher',
    hp: 1180, atk: 134, def: 82, spd: 92, basicPower: 92,
    passive: { id: 'overheat', name: '過熱', desc: '自分のHPが低いほど与ダメージ上昇（最大 +35%）。ロスター最高火力。' },
    od: { id: 'greateruption', name: '大噴火', desc: '敵全体を焼き払い火傷を付与。自身のHPを20%消費する。', power: 104 },
    build: { archetype: 'theropod', seed: 12131, bulk: 1.14, scale: 1.12, sail: true, spikes: true },
    habitat: ['emberfield'], rarity: 4,
    flavor: '瀕死になるほど熱が上がる。最後の一撃のためだけに生きている。',
  },
];
